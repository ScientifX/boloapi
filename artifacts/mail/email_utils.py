...
class GraphAPIEmailSender:
    ...
    def send_email(
        ...
        """
        Send an email via Microsoft Graph API in standard MIME/HTML format.
        
        Prevents winmail.dat attachment by:
        1. Setting contentType to "HTML" (not RTF)
        2. Using singleValueExtendedProperties to disable TNEF format
        3. Forcing standard MIME encoding
        ...
        try:
            ...
            # Build email message with settings to prevent winmail.dat
            message = {
                "message": {
                    "subject": subject,
                    "body": {
                    ...
                    # Add custom header to identify sender
                    ...
                    # Explicitly disable TNEF/RTF format to prevent winmail.dat
                    # This forces standard MIME/HTML format
                    "singleValueExtendedProperties": [
                        {
                            "id": "Integer 0x3FEF",  # PidTagInternetMessageFormat
                            "value": "1"  # 1 = Send as standard MIME (not TNEF)
                        }
                    ]
                },
            ...
            logger.info(f"Successfully sent email to {to_address} (standard MIME/HTML format, TNEF disabled)")
            return True
...
def send_api_key_email(to_email: str, api_key: str) -> bool:
    ...
    <body>
        <div class="header">
            <h1>ðŸ”‘ {EmailConfig.FROM_NAME} Key Reset</h1>
        </div>
        <div class="content">
            ...
            <div class="warning">
                ...
                â€¢ Your old API key and all tokens generated from it are now invalid<br>
                â€¢ Save this key securely - you won't be able to retrieve it again<br>
                â€¢ Never share your API key or commit it to version control<br>
                â€¢ If compromised, reset your key immediately
            </div>
